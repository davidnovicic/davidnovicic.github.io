...
const SkillsItem = ({ title, year, des, moreInfo, stateInfo }: Props) => {
  return (
    <div className=" mt-15 md:mt-15 ml-10 mb-10 items-center justify-center ">
      ...
      <button
        onClick={() => moreInfo()}
        className=" group-hover:translate-x-1 group-hover:-translate-y-1 hover:scale-120  hover:bg-transparent hover:border-1 duration-300 hover:text-white mt-10 bg bg-zinc-800 text-white text-sm rounded-full w-[85px] h-[30px]"
      >
        {" "}
