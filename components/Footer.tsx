...
const Footer = () => {
  return (
    // <div className="text-zinc-300 pt-[40rem] md:pt-[15rem] bg-black">
    //   <div className="overflow-hidden bg-black grid border-b-[1px] pb-[4rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[60%] mx-auto gap-[3rem] p-6">
    ...
    //           Send Us Email{" "}
    //         </h1>
    //         <p className="text-[13px] md:text-[17px] w-[90%] text-white opacity-60">
    //           {" "}
