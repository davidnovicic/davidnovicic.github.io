...
const Footer = () => {
  return (
    <div className="text-zinc-300 pt-[8rem] bg-black ">
      <div className="lg:ml-70 grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem]">
      ...
      <div className="pb-3 w-[70%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between">
